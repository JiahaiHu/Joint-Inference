...
Follow the [Sedna installation document](https://github.com/kubeedge/sedna/blob/main/docs/setup/install.md) to install Sedna.
...
These images are generated by the script [build_images.sh](https://github.com/kubeedge/sedna/blob/main/examples/build_image.sh).
...
Note the setting of the following parameters, which have to same as the script [little_model.py](/little_model/little_model.py):
